...
\begin{proof}
  ...
  \begin{figure}[ht]
    ...
    \begin{tikzpicture}[inner sep=0.5cm]
      ...
      \node at (0, -2) (orc) {$\vec{c} = \cbc[\orc](\vec{m})$};
      \node at (0, -4) (get_mb) {$\vec{m}_b$};
      \node at (0, -5) (enc) {$\vec{c} = \cbc[\orc](\vec{m}_b)$};
      \node at (0, -6) (orc_2) {$\vec{c} = \cbc[\orc](\vec{m})$};

      % adversary B
      \node at (6, -2) (get_m) {$\vec{m}$};
      \node at (6, -3) (get_m0m1) {$\vec{m}_0, \vec{m}_1$};
      \node at (6, -4) (samp_b) {$b \unisamp \binset{}$};
      \node at (6, -5) (get_c) {$\vec{c}$};
      \node at (6, -6) (get_m_2) {$\vec{m}$};
      \node at (6, -7) (get_bp) {$b'$};
      \node at (6, -8) (return) {return $b \issame b'$};

      % adversary A
      \node at (12, -2) (chs_m) {choose $\vec{m}$};
      \node at (12, -3) (chs_m0m1) {choose $\vec{m}_0, \vec{m}_1$};
      \node at (12, -5) (get_c_2) {$\vec{c}$};
      \node at (12, -6) (chs_m_2) {choose $\vec{m}$};
      \node at (12, -7) (chs_bp) {choose $b' \in \binset{}$};
      ...
      \draw[red, <-] (get_mb) -- (samp_b)
      node[midway, above, inner sep=0.1cm] {query $\vec{m}_b$};
      \draw[red, ->] (enc) -- (get_c)
      node[midway, above, inner sep=0.1cm] {response $\vec{c}$};
